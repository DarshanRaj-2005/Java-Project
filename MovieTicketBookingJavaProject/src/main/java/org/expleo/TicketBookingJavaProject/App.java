...
//------------Author Name: Tamil Kumar, Darshan Raj, Krishna Prasath---------------
...
public class App {
    ...
    // DAO instances for static method replacements
    private static TheatreRepositoryImpl theatreDAO = new TheatreRepositoryImpl();
    private static MovieRepositoryImpl movieDAO = new MovieRepositoryImpl();
    private static BookingRepositoryImpl bookingDAO = new BookingRepositoryImpl();
    private static UserRepositoryImpl userDAO = UserRepositoryImpl.getInstance();
    ...
    private static void viewMovieReport(Theatre theatre) {
        ...
        List<Movie> movies = movieDAO.getMoviesByTheatre(theatre.getId());
    ...
    private static void viewProfile(User user) {
        ...
        if (user.getRole().equalsIgnoreCase("Officer")) {
            Theatre theatre = theatreDAO.getTheatreById(user.getTheatreId());
            if (theatre != null) {
                System.out.println("Theatre : " + theatre.getName() + " (" + theatre.getCity() + ")");
