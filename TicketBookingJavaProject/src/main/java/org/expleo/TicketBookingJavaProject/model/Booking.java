...
/**
 * Model class representing a Booking. Contains all information about a ticket
 * booking.
 */
public class Booking {
	 ...
	 */
	public Booking(String bookingId, String movieId, int theatreId, String showtime, List<String> seatLabels,
