...
public class BookingController {
	...
	/**
	 * Starts the booking flow for a specific theatre (used by Officers). Officer
	 * can only book tickets for their assigned theatre.
	 * 
	...
	/**
	 * Calculates price based on seat rows. Top 3 rows (A, B, C): Rs. 190 Next rows
	 * (D, E, F, G): Rs. 160 Bottom rows (H, I, J): Rs. 60
	 */
	...
	private void processPayment(Movie movie, Theatre theatre, String city, String showtime, List<String> selectedSeats,
		...
		Booking booking = new Booking(bookingId, userId, movie.getId(), theatre.getId(), showtime, selectedSeats,
				bill.getTotalAmount(), "CONFIRMED");
