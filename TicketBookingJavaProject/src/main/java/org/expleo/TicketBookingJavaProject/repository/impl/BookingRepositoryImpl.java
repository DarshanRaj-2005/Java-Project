...
public class BookingRepositoryImpl {
    ...
    public static List<org.expleo.TicketBookingJavaProject.model.City> getCities() { return cities; }
    public static void addCity(org.expleo.TicketBookingJavaProject.model.City city) { cities.add(city); }

    public static List<org.expleo.TicketBookingJavaProject.model.Showtime> getShowtimes() { return showtimes; }
    public static void addShowtime(org.expleo.TicketBookingJavaProject.model.Showtime showtime) { showtimes.add(showtime); }
